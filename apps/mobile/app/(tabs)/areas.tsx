...
const styles = StyleSheet.create({ page: { padding: 16, paddingBottom: 28, gap: 14 }, eyebrow: { fontFamily: 'Inter_700Bold', fontSize: 11, letterSpacing: 1.4, marginTop: 12 }, title: { fontFamily: 'Inter_800ExtraBold', fontSize: 28, marginTop: 4 }, subtitle: { fontFamily: 'Inter_400Regular', fontSize: 13, marginTop: 5 }, list: { gap: 10 } });
